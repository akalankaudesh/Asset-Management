...
public class Employee extends Super_Entity {
    private int emp_id;
    ...
    public Employee(int emp_id, String emp_name, String emp_department, String emp_address, int emp_telephone, double emp_monthly_salary) {
        this.emp_id = emp_id;
